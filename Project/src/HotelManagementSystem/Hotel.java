...
class Hotel {
	...
	static void CustDetails(int i, int rn)
	{
		...
		switch(i){
		case 1: hotel_ob.deluxe_singleerrom[rn]= new Doubleroom(name,contact,gender,name2,contact2,gender2);
			break;
		...
		case 3: hotel_ob.luxury_singleerrom[rn]= new Singleroom(name,contact,gender);
			break;
		case 4: hotel_ob.luxury_singleerrom[rn]= new Singleroom(name,contact,gender);
			break;
	...
	static void availability(int i)
	{
		...
		case 1: for(j=0;j<10;j++)
		{
			...
			break;
		case 2: for(j=0;j<hotel_ob.deluxe_doublerrom.length;j++)
		{
			if(hotel_ob.deluxe_doublerrom[j]==null)
				count++;
		}
			break;
		case 3: for(j=0;j<hotel_ob.luxury_singleerrom.length;j++)
		{
			if(hotel_ob.luxury_singleerrom[j]==null)
				count++;
		}
			break;
		case 4: for(j=0;j<hotel_ob.deluxe_singleerrom.length;j++)
		{
			if(hotel_ob.deluxe_singleerrom[j]==null)
				count++;
		}
		...
		System.out.println("Numbers of room available: "+count);
	}
	static void bill(int rn, int rtype)
	{
		...
		case 1: amount+=4000;
			System.out.println("\nRoom Charge -"+4000);
			System.out.println("\n==================");
			System.out.println("Food charge:- ");
			System.out.println("===============");
